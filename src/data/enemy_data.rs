    ...
    pub fn new(ground_data: GroundData) -> Self {
        Self {
            ...
            bat_animation: Animation {
                speed_in_wc_per_tick: ground_data.speed_in_wc_per_tick + 4,
                ticks_in_movement: 8,
            },
            ...
            bee_animation: Animation {
                speed_in_wc_per_tick: ground_data.speed_in_wc_per_tick + 2,
                ticks_in_movement: 2,
            },

            // Bug needn't move. It just stays put on the ground
            bug_animation: Animation {
                speed_in_wc_per_tick: ground_data.speed_in_wc_per_tick,
                ticks_in_movement: std::u8::MAX,
            },

            // Mouse should move
            mouse_animation: Animation {
                speed_in_wc_per_tick: ground_data.speed_in_wc_per_tick + 1,
                ticks_in_movement: 6,
            },
